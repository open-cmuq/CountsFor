...
class CourseService:
    ...
    def fetch_courses_by_department(self, department: str):
        ...
        return CourseListResponse(
            courses=[CourseResponse(course_code=c.course_code,
                                    course_name=c.name, requirements={}) for c in courses]
        )

    def fetch_courses_by_requirement(self, cs_requirement=None,
                                     is_requirement=None, ba_requirement=None, bs_requirement=None):
